...
type Step = "voice" | "photo" | "interview" | "review" | "success";
...
export default function OnboardingPage() {
  ...
  const handleInterviewComplete = async (history: any[]) => {
    setStep("success");
    setProgress(90);
    setIsProcessing(true);

    try {
      // 1. Generate Prompt & Extract Name
          ...
          {step === "interview" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-400">
                  Parla con Claude per estrarre il tuo DNA professionale.
                </p>
              </div>
